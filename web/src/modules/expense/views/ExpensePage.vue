          ...
          <table class="w-full text-[calc(13.5px*var(--jafa-text-scale,1))]">
            ...
            <tbody>
              ...
              >
                ...
                <td class="py-3.5 px-2 text-right tabular-nums font-semibold text-[var(--jafa-text)]">−€{{ (exp.cost ?? exp.amount).toFixed(2) }}</td>
          ...
          <template v-if="currentMonthExpenses?.length">
            <div class="relative h-[200px]">
              ...
              <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                ...
                <span class="text-[calc(22px*var(--jafa-text-scale,1))] font-semibold tabular-nums text-[var(--jafa-text)] leading-tight mt-0.5">€{{ currentTotal.toFixed(2) }}</span>
              </div>
            </div>
          ...
          <template v-if="upcomingBills.length">
            <div class="flex flex-col">
              ...
              >
                ...
                <div class="text-[calc(13px*var(--jafa-text-scale,1))] font-semibold text-[var(--jafa-text)] tabular-nums">−€{{ b.cost.toFixed(2) }}</div>
              </div>
            </div>
            <div class="mt-auto pt-3 flex items-center justify-between border-t border-[var(--jafa-border)]">
              ...
              <span class="text-[calc(13px*var(--jafa-text-scale,1))] font-semibold tabular-nums text-[var(--jafa-text)]">€{{ upcomingTotal7d.toFixed(2) }}</span>
            </div>
          </template>
